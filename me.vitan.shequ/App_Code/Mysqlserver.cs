...
namespace Mysqlserver
{
    ...
    public class SqlServerDataBase
    {
        ...
        {
            //string strConn = "server=.VITAN; database=hotel; Integrated Security=true;User ID=sa;Password=123456;";
            //string strConn = "server=.\\SQLEXPRESS;DataBase=hotel;Trusted_Connection=true";
            string strConn = "server = VITAN\\VITAN; uid = sa; pwd = 123456; database = community";
            try
            {
